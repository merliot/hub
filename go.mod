...
require (
	...
	github.com/merliot/garage v0.0.0-20240210075335-9d1fb0b8f699
	github.com/merliot/ps30m v0.0.0-20240210075317-e033ff5efab0
	github.com/merliot/relays v0.0.0-20240210075402-be1f3b664f75
)
